...
class CompetitorsNetwork extends Component {
    constructor(props) {
        super(props)
        this.state = {
            apiData: false,
    ...
    componentDidMount() {
        fetch('http://165.227.158.131/dp/api/v160/network/twitter/ma/100')
...
export default CompetitorsNetwork 
